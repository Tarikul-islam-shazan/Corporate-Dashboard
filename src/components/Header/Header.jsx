      ...
      <React.Fragment>
            ...
            <Navbar color="primary">
              ...
              <Navbar.Container position="end">
                <Navbar.Item renderAs="div">
                  <Heading size={3} className="is-uppercase has-text-white ">
              ...
              <Navbar.Container position="end">
                <Navbar.Item>
                  <Button className="Header__logoutBtn" onClick={this.handleLogout}>
                    Logout
                  </Button>
                </Navbar.Item>
              </Navbar.Container>
        ...
        <Section className="has-background-light header_section-padding2">
          <Container fluid className="header_container">
            ...
            <Heading subtitle size={6} className="has-text-primary has-averta-bold-font">
